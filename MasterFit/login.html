...
<body>
    ...
    <nav class=" alert navbar navbar-expand-lg bg-warning p-5 ">
        <div class="container-fluid">
            <a class="navbar-brand nvbw" href="index.html" onmouseover="uScale(this)"
            onmouseout="dScale(this)">
                <img src="imgs/logo/logopreta.png" alt="" class="nvblg">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link nvbw movingBox" href="login.html" onmouseover="uScale(this)"
                        onmouseout="dScale(this)">
                            Área do Cliente</a>
                    </li>
                    <li class="nav-item nvbw">
                        ...
                        onmouseout="dScale(this)">
                            Conheça nossas promoções</a>
                    </li>
                    <li class="nav-item nvbw ">
                        <a class="nav-link movingBox" href="maps.html" onmouseover="uScale(this)"
                        onmouseout="dScale(this)">
                            Onde nos encontrar?</a>
                    </li>
                </ul>
                    ...
                    <div class="col aling-self-center">
                        <div class="card alert alert-dark lgn ">
                            <div class="card-header text-center alert">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10em" height="10em" fill="currentColor"
    ...
    <div class="container-fluid">
        <footer class="p-5">
            <img src="imgs/logo/logopreta.png" alt="" class="nvblg2">
            <hr>
